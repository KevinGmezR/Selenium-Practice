...
public class CartPage {
    ...
    public boolean comprobateProductInCart(String productName) {
        driver.get("https://www.saucedemo.com/cart.html");
        WebElement element = driver.findElement(By.xpath("//*[@Class='inventory-item-name' and contains(text(),'" + productName + "')]"));
        if(element != null) {
            return true;
        }else{
            return false;
